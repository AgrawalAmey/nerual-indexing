...
class Model(object):
    ...
    def __init__(self, resnet_size, bottleneck, embedding_size, num_filters,
                 kernel_size,
        ...
        Args:
            ...
            embedding_size: The size of output embedding.
    ...
    def __call__(self, inputs, training):
        ...
        Returns:
            A embeddings Tensor with shape [<batch_size>, self.embedding_size].
        """
        ...
        inputs = tf.layers.dense(inputs=inputs, units=self.embedding_size)
